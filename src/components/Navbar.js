  ...
  return (
    <nav className="flex items-center justify-between flex-wrap p-5 bg-gradient-to-r from-indigo-500 from-30% to-sky-500">
      ...
      <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
        ...
        <div>
          <button className="inline-block bg-gradient-to-r from-sky-500 from-30% to-indigo-500 text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-blue-500 hover:bg-white mt-4 lg:mt-0 hover:shadow-md">Benimle çalışmak ister misin?</button>
        </div>
      </div>
    </nav>
  );
